        ...
        <div className="bg-penabur-blue p-8 pb-12 rounded-b-[2.5rem] shadow-md relative z-10">
          <div className="flex justify-between items-center text-white">
            ...
            <button 
                ...
                className="bg-red-500/20 p-2 rounded-xl hover:bg-red-500/40 transition-colors backdrop-blur-sm border border-red-500/30 text-red-100"
                title="Keluar"
            >
              <LogOut size={20} />
            </button>
        ...
        <div className="px-6 pt-20 pb-10">
          ...
          <div className="grid grid-cols-2 gap-5">
              ...
              <button 
                  ...
                  className="bg-white p-6 rounded-3xl shadow-sm border border-gray-100 flex flex-col items-center justify-center gap-4 hover:shadow-md hover:scale-[1.02] transition-all group cursor-pointer h-40">
              ...
              <button onClick={() => navigate('/user/profile')} className="col-span-2 bg-white p-5 rounded-3xl shadow-sm border border-gray-100 flex items-center justify-between px-8 hover:shadow-md hover:scale-[1.01] transition-all group cursor-pointer">
                  ...
                  <div className="text-gray-300 group-hover:text-penabur-blue transition-colors">➔</div>
              </button>
          </div>
        </div>
